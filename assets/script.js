...
function getWeather() {
    ...
    $.get(currentWeatherQuery).then(function(response){
        ...
        //UV Query and AJAX
        var uvQuery = "https://api.openweathermap.org/data/2.5/uvi?lat=" + lat + "&lon=" + lon + "&appid=523e373f17a7c9fd9087b7beb7314c6c"
